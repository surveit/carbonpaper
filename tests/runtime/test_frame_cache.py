...
def _two_input_stage() -> Stage:
    return parse_stage({
        ...
        "signature": {"form": "replaces", "produces": _X["columns"]},
...
def _enrich_stage() -> Stage:
    return parse_stage({
        ...
        "signature": {
            "form": "extends",
            "reads": [{"input": "left", "columns": [{"name": "x", "type": "int", "nullable": True}]},
                      {"input": "right", "columns": [{"name": "x", "type": "int", "nullable": True}]}],
...
def _aggregate_stage() -> Stage:
    return parse_stage({
        ...
        "signature": {
            "form": "replaces",
            "reads": [{"input": "src", "columns": [{"name": "g", "type": "str", "nullable": True}]}],
