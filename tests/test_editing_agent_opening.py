...
_OFFERS_REST_ON = {
    "Explain how this value was built": ("read_stage_output_rows", "read_draft_stage"),
    "Explain how to use this page": (),
    "Explain what changed in this version": ("list_versions", "read_version_stage"),
    "Run this version as a test": ("run_workflow_test",),
    "Compare the saved versions": ("list_versions", "read_version_stage"),
    ...
    "Explain what this workflow does": ("list_versions", "read_version_stage"),
    ...
    "Explain what this project does": ("list_versions", "get_project_status"),
