...
def _a_run(tmp_path, parameters: RunParameters | None = None) -> TestClient:
    ...
    for slug, value, shape_id in (
        ...
        WorkflowOutput(
            ...
            citation=StageOutputCellCitation(project_id=_PROJECT, run_id=_RUN, stage_id="ai_spend_totals", row_ordinal=0,
...
def test_the_context_pre_fills_from_the_newest_standing_claim(tmp_path):
    ...
    WorkflowOutput(
        ...
        citation=StageOutputCellCitation(project_id=_PROJECT, run_id="20260902T090000.000000", stage_id="ai_spend_totals", row_ordinal=0,
