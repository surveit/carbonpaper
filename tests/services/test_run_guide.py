...
_STAGES: list[dict[str, Any]] = [
    {"id": "load_rows", "name": "Load rows", "type": "input_data",
     "connector": {"kind": "file"},
     "signature": {"form": "replaces", "produces": [_DOC_ID]}},
    {"id": "load_sources", "name": "Load sources", "type": "input_data",
     "connector": {"kind": "file"},
     "signature": {"form": "replaces", "produces": [_DOC_ID, _SOURCE]}},
    {"id": "add_flag", "name": "Flag rows", "type": "python_row_function",
     "inputs": [{"id": "load_rows", "schema": _ROWS}],
     "function": _ROW_FUNCTION,
     "signature": {"form": "extends", "adds": [_FLAG]}},
    ...
    {"id": "attach_source", "name": "Attach the source", "type": "enrich",
     ...
     "signature": {"form": "extends",
                   "reads": [{"input": "keep_flagged", "columns": [_DOC_ID]},
                             {"input": "load_sources", "columns": [_DOC_ID]}],
                   "adds": [_SOURCE]}},
]
...
def test_a_publish_stage_promising_no_table_writes_nothing():
    publish = parse_stage({
