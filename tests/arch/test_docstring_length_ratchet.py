...
_GRANDFATHERED: frozenset[str] = frozenset(
    {
        ...
        "app/models/run_manifest.py::QueueStats",
        "app/models/run_manifest.py::RunManifest",
        "app/models/run_manifest.py::RunManifest._halted_at_to_list",
        "app/models/run_manifest.py::RunManifest.clear_halt",
        "app/models/run_manifest.py::RunManifest.record_dropped_columns",
        "app/models/run_manifest.py::RunManifest.settle_stage_records",
        "app/models/run_manifest.py::RunManifest.to_dict",
        "app/models/run_manifest.py::StageContribution",
        "app/models/run_manifest.py::StageErrorInfo",
        "app/models/run_manifest.py::StageRecord",
        "app/models/run_manifest.py::StageRecord.add_note",
        "app/models/run_manifest.py::StageRecord.record_with_status",
        ...
        "app/runtime/stages/execution.py::_strip_and_trim",
        ...
        "app/runtime/stages/python_functions.py::handle_pandas_frame_function",
        ...
        "app/web/routers/run_stage.py::run_stage_rows",
        "app/web/routers/run_stage.py::run_stage_scratch_preview",
        ...
        "tests/runtime/test_frame_cache.py::test_the_registered_pandas_frame_function_replays_its_recorded_frame",
...
_GRANDFATHERED_ENTRANCE_PROSE: frozenset[str] = frozenset(
    {
        ...
        "app/web/routers/run_stage.py::run_stage_rows_csv",
