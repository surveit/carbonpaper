...
_GRANDFATHERED: frozenset[str] = frozenset(
    {
        ...
        "app/agents/compiler/tools.py::make_editing_tools.add_stage",
        "app/agents/compiler/tools.py::make_editing_tools.create_draft",
        "app/agents/compiler/tools.py::make_editing_tools.describe_workflow",
        "app/agents/compiler/tools.py::make_editing_tools.edit_stage",
        "app/agents/compiler/tools.py::make_editing_tools.get_current_project",
        "app/agents/compiler/tools.py::make_editing_tools.read_draft",
        "app/agents/compiler/tools.py::make_editing_tools.remove_draft_stage",
        "app/agents/compiler/tools.py::make_editing_tools.remove_stage",
        "app/agents/compiler/tools.py::make_editing_tools.save_version",
        "app/agents/compiler/tools.py::make_editing_tools.set_draft_stage",
        ...
        "app/compiler/stage_tests.py::start_stage_test_derivation_agent",
        ...
        "app/core/agent/registry.py::build_mcp_server",
        ...
        "app/evals/runner.py::_derive_override_output",
        ...
        "app/mcp/server.py::add_stage",
        "app/mcp/server.py::catch_stage_edit_refusals",
        "app/mcp/server.py::create_project",
        "app/mcp/server.py::describe_workflow",
        "app/mcp/server.py::edit_stage",
        "app/mcp/server.py::generate_data_model",
        "app/mcp/server.py::generate_stage_tests",
        "app/mcp/server.py::get_project_status",
        "app/mcp/server.py::get_run_status",
        "app/mcp/server.py::list_projects",
        "app/mcp/server.py::remove_stage",
        "app/mcp/server.py::run_session_manager",
        "app/mcp/server.py::run_stage_tests",
        "app/mcp/server.py::run_workflow",
        "app/mcp/server.py::run_workflow_test",
        "app/mcp/server.py::save_version",
        ...
        "app/models/schema.py::_numeric_bounds",
        ...
        "app/models/stage_base.py::StageBase",
        "app/models/stage_base.py::StageBase._config_columns_resolve",
        "app/models/stage_base.py::StageBase._empty_tests_means_absent",
        "app/models/stage_base.py::StageBase._output_schema_deliverable",
        "app/models/stage_base.py::StageBase._schemas_declared",
        "app/models/stage_base.py::StageBase.compute_definition_fingerprint",
        "app/models/stage_base.py::StageBase.find_authored_code_block",
        "app/models/stage_base.py::StageBase.find_config_column_issues",
        "app/models/stage_base.py::StageBase.find_output_schema_issues",
        "app/models/stage_base.py::StageBase.fingerprint_blocks",
        "app/models/stage_base.py::StageBase.is_grain_and_order_preserving",
        "app/models/stage_base.py::StageCommon",
        "app/models/stage_base.py::is_grain_and_order_preserving",
        "app/models/stages/aggregate.py::derive_aggregate_output_types",
        "app/models/stages/aggregate.py::find_aggregate_column_issues",
        "app/models/stages/aggregate.py::find_aggregate_output_issues",
        ...
        "app/models/stages/human_review_queue.py::RowReviewDecision",
        "app/models/stages/human_review_queue.py::find_queue_filter_column_issues",
        "app/models/stages/join.py::JoinConfig",
        "app/models/stages/join.py::JoinStage",
        "app/models/stages/join.py::derive_join_output_types",
        ...
        "app/models/stages/shared.py::find_declared_vs_derived_issues",
        ...
        "app/models/stages/union.py::find_union_output_issues",
        ...
        "app/runtime/executor.py::_apply_row_slicing",
        "app/runtime/executor.py::_consume_cancel",
        "app/runtime/executor.py::_duplicate_row_groups",
        ...
        "app/runtime/executor.py::_reject_duplicate_input_rows",
        ...
        "app/runtime/runner.py::resolve_version_id",
        ...
        "app/runtime/stages/human_review_queue.py::_derive_queue_stats",
        "app/runtime/stages/human_review_queue.py::_find_pending_reviews",
        "app/runtime/stages/human_review_queue.py::_pass_row_through",
        ...
        "app/runtime/trace.py::StageTransform",
        "app/runtime/trace.py::TraceEnd",
        "app/runtime/trace.py::_advance",
        "app/runtime/trace.py::_advance_positionally",
        "app/runtime/trace.py::_advance_via_lineage",
        "app/runtime/trace.py::_columns_parent_id",
        "app/runtime/trace.py::_is_row_preserving",
        "app/runtime/trace.py::_lineage_hop",
        "app/runtime/trace.py::_not_preserving_message",
        ...
        "app/services/review.py::_build_output_row",
        "app/services/review.py::_resolve_human_score",
        "app/services/review.py::record_decision",
        "app/services/run.py::RunStageDef",
        "app/services/run.py::_run_in_background",
        "app/services/run.py::load_run_stages",
        ...
        "app/web/loading.py::_unreadable_run_row",
        ...
        "app/web/routers/node_review.py::_find_derivation_failure",
        ...
        "app/web/routers/review.py::_DecisionDisplay",
        "app/web/routers/review.py::_build_review_items",
        "app/web/routers/review.py::_display_decision",
        "app/web/routers/review.py::_find_join_keys",
        "app/web/routers/review.py::_load_decided_entries",
        "app/web/routers/review.py::_load_model_input_lookup",
        "app/web/routers/review.py::_load_scored_stage",
        "app/web/routers/review.py::_resolve_queue_row",
        "app/web/routers/review.py::_resolve_scored_input_frame",
        "app/web/routers/review.py::queue_decide",
        "app/web/routers/runs.py::RunGraph",
        "app/web/routers/runs.py::_artifact_links",
        ...
        "tests/arch/test_import_graph.py::describe_core_package_prefixes",
        "tests/arch/test_import_graph.py::find_app_internal_edges",
        "tests/arch/test_import_graph.py::find_fan_in_violations",
        "tests/arch/test_import_graph.py::find_fan_out_violations",
        "tests/arch/test_import_graph.py::find_import_cycles",
        "tests/arch/test_import_graph.py::is_core_module",
        ...
        "tests/models/stages/test_aggregate_output_schema.py::_aggregate_stage",
        "tests/models/stages/test_join_columns.py::test_find_join_column_issues_ignores_select",
        "tests/models/stages/test_join_columns.py::test_key_on_the_wrong_side_rejected",
        "tests/models/stages/test_join_columns.py::test_select_referencing_absent_column_is_rejected_by_output_check",
        ...
        "tests/runtime/test_hrq_cache.py::test_every_row_rejected_still_emits_every_row_with_the_declared_columns",
        "tests/runtime/test_hrq_cache.py::test_fingerprint_matches_the_drivers_own_row_dict",
        "tests/runtime/test_hrq_cache.py::test_input_fingerprint_matches_original_row_before_any_bookkeeping_stamped",
        ...
        "tests/runtime/test_hrq_cache.py::test_queue_stats_count_every_row_including_the_rejected_one",
        "tests/runtime/test_hrq_cache.py::test_queue_stats_hold_when_every_row_is_served_from_the_cache",
        "tests/runtime/test_hrq_cache.py::test_rejected_row_stays_in_output_carrying_its_rejection",
        ...
        "tests/runtime/test_hrq_cache.py::test_the_documented_downstream_filter_excludes_only_the_rejected_row",
        "tests/runtime/test_output_projection.py::_rating_stage",
        "tests/runtime/test_output_projection.py::test_human_review_queue_output_missing_a_declared_column_raises",
        ...
        "tests/services/test_review.py::test_record_decision_reject_writes_the_row_the_rejection_produces",
        ...
        "tests/test_column_projection.py::_llm_stage",
        ...
        "tests/test_eval_scoring.py::_stage",
        ...
        "tests/test_review_routes.py::_load_quotes_stage",
        ...
        "tests/test_review_routes.py::test_e2e_decide_approve_modify_and_reject_then_resume_completes",
        ...
        "tests/test_run_loop_semantics.py::_queue_stage",
        ...
        "tests/test_runner.py::test_cli_bust_cache_flag_reaches_execute_run",
        ...
        "tests/test_runs_index_listing.py::_pre_rename_manifest",
        "tests/test_runs_index_listing.py::test_a_manifest_predating_the_field_reads_as_not_a_test",
        "tests/test_runs_index_listing.py::test_a_workflow_test_run_is_listed_and_marked_is_test_run",
        "tests/test_runs_index_listing.py::test_valid_and_legacy_manifests_listed_side_by_side",
        "tests/test_schema_capabilities.py::test_range_on_str_column_rejected_use_enum",
        "tests/test_schema_capabilities.py::test_spec_column_fields_derived_from_model",
        ...
        "tests/test_stage.py::test_input_data_rejects_missing_output_schema",
        ...
        "tests/test_stage_test_derivation.py::test_a_stage_with_no_summary_cannot_derive_examples",
        "tests/test_stage_test_derivation.py::test_no_corner_cases_still_renders_a_task",
        "tests/test_stage_test_derivation.py::test_task_never_contains_the_methodology_document",
        "tests/test_stage_test_generation_route.py::_FakeDeriverAgent",
        "tests/test_stage_test_generation_route.py::_FakeDeriverAgentNoAnswer",
        ...
        "tests/test_stage_test_generation_route.py::test_generate_tests_rejects_python_stage_without_output_schema",
        "tests/test_stage_test_generation_service.py::_FakeDeriverAgent",
        "tests/test_stage_test_generation_service.py::_FakeDeriverAgentNoAnswer",
        "tests/test_stage_test_generation_service.py::_seed_project",
        "tests/test_stage_test_generation_service.py::_suite_model",
        "tests/test_stage_test_generation_service.py::test_failed_derivation_is_persisted_into_the_session",
        ...
        "tests/test_union_and_filter_runtime.py::test_trace_follows_lineage_after_the_stage_limit_trims_kept_rows",
        ...
        "tests/test_workflow.py::test_check_edge_schemas_raises_on_an_upstream_declaring_no_output_schema",
