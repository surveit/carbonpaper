...
limit=null) — the source reads its whole bound file and nothing below it runs —
then profile_stage_output_data_range on what it wrote. edit_stage tightens the
schema afterwards.)
