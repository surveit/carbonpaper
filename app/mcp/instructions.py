...
full one — get_run_status(project_id, run_id, wait_seconds) waits it out to its outcome,
so following a run costs one call and not one per check. Publishing is a
