...
full one — wait_for_run(project_id, run_id) blocks in ONE call until that run settles
(get_run_status reads the manifest without waiting; do not loop on it). Publishing is a
