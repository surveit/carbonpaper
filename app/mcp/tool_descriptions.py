"""The model-facing description of every glassbox MCP tool, keyed by tool name.

Held here rather than in a docstring so the text the model reads is an explicit
argument to @mcp.tool, not a side effect of how the function happens to be
documented."""
