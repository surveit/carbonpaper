...
def call_llm_batch(
    ...
    *,
    ...
    differences are the caller's: `target_model` is a list-of-items schema rather
    ...
    model_name = str(model or llm_config.model or DEFAULT_MODEL)
    return _generate(llm_config, instructions, task, model_name, reply_schema, usage_out)
