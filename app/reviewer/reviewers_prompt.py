"""The six reviewers' system prompts: each one's place, its evidence, and its one kind."""
from __future__ import annotations

_THE_PLACE = (
    "YOUR PLACE. You are one of six reviewers reading ONE sentence a journalist proposes "
    ...
    "other reviewers read other parts of the same run; you never see them and they never "
...
_THE_PHRASES = (
    ...
    "  `----- PHRASES -----` the grounding reviewer read the sentence before you and "
    ...
    "already the grounding reviewer's finding and becomes a `gap` challenge in its name; "
...
_MEANING_JOB = (
    ...
    "is reviewed on its own, from the start. A rewrite carries no figure the pool does not "
    "print either.\n\n"
)
