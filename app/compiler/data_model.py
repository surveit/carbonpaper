...
The sibling of `app.compiler.stage_tests` (one stage → its derived test suite): this is
prose → named schemas. It builds an `app.core.agent.agent.Agent` whose target schema is
