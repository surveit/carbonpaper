...
- llm_transform — a step that needs judgment or reads unstructured text into structure.
  Its prompt_template is rendered with Python's str.format_map: inject an input column
  with SINGLE braces — {column_name} (NOT {{column_name}}, which renders as a literal).
