...
REVIEW_GUIDE_SYSTEM_PROMPT = (
    ...
    "you have no tool that reads the project, and cannot see any newer version the "
    "non-engineer has saved since. Narrating one of those would describe a workflow "
    "this version does not contain, and is rejected on the way in.\n\n"
