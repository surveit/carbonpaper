...
1. Is the value's GENERATION constrained to a discrete set — a dropdown on the
   ...
   be open. That is a claim about the world: research settles it, and the observed
   values confirm or refute it.
2. Do WE consume it as a discrete set — a later stage switching per value, or
   ...
   observed: an unlisted value otherwise takes an else-branch or joins to nothing,
