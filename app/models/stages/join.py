...
NODE_TYPE_SPECS: dict[str, NodeTypeSpec] = {
    "enrich": NodeTypeSpec(
        ...
        notes=(
            ...
            "columns (nullable — an unmatched row lands null); every subject column flows."
        ),
    ),
    "expand": NodeTypeSpec(
        ...
        notes=(
            ...
            "key pair needs no entry. The signature adds exactly the landed columns "
            "(nullable — an unmatched row lands null); every subject column flows."
        ),
    ),
}
