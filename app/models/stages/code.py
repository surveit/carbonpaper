...
SUMMARY_DESCRIPTION = (
    ...
    "the schema, and each one wrapped in `backticks` so the page can set it apart from "
    "the prose. Anything conditional or surprising about the behaviour — rows left "
